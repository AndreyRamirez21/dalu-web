...
export function WhatsAppFloatingButton() {
  return (
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 hover:bg-[#1ebc59] focus:outline-none focus:ring-4 focus:ring-[#25D366]/30"
    >
        <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-75 animate-ping [animation-duration:2.5s]" />
        <span className="absolute inset-0 rounded-full bg-[#25D366]/40 animate-pulse [animation-duration:3s]" />
