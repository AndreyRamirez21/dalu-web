...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'proceso-compra', element: withSuspense(<LegalPage />) },
      ...
      { path: 'datos', element: withSuspense(<LegalPage />) },
      { path: 'propiedad', element: withSuspense(<LegalPage />) },
      { path: 'garantia', element: withSuspense(<LegalPage />) },
